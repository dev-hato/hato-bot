...
2. [Launch a demo app · Fly Docs](https://fly.io/docs/getting-started/launch-demo/)の `1. Install flyctl` に記載されている手順で `fly` コマンドをインストールします。
3. [Launch a demo app · Fly Docs](https://fly.io/docs/getting-started/launch-demo/)の `2. Sign up or sign in` に記載されている手順でfly.ioへの登録・ログインを行います。
