...
class TestAmesh(unittest.TestCase):
    ...
    def amesh_upload_png_test(
        self, mocker: requests_mock.Mocker, place: str, coordinate: List[str], msg: str
    ):
        """
        ...
        with open(
            ...
            client1 = self.get_amesh_test(
                mocker, place, coordinate, picture_file.read()
            )
    ...
    def test_amesh_with_params(self):
        ...
        with requests_mock.Mocker() as mocker:
            ...
            self.amesh_upload_png_test(
                mocker, " ".join(coordinate), coordinate, "雨雲状況をお知らせするっぽ！"
            )
