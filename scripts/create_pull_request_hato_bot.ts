...
export async function createPullRequestHatoBot(github:InstanceType<typeof GitHub>, pullsCreateParams:RestEndpointMethodTypes["pulls"]["create"]["parameters"], commonParams:{
  owner: string;
  repo: string;
}) {
